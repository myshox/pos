...
export default function StoreSettings() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-slate-800">{t('storeSettingsTitle')}</h2>
      <p className="text-slate-600 text-sm">{t('storeSettingsHint')}</p>
      ...
      <div className="card-market rounded-2xl p-5 sm:p-6 max-w-xl">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          />
          <div>
            <span className="font-medium text-slate-800">{t('pinDisabledLabel')}</span>
            <p className="text-slate-500 text-sm mt-0.5">{t('pinDisabledHint')}</p>
          </div>
        </label>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card-market rounded-2xl p-5 sm:p-6 space-y-4 max-w-xl">
        <label className="block">
          <span className="text-sm font-medium text-slate-600">{t('storeName')}</span>
          <input
            type="text"
            value={form.name}
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-600">{t('storeAddress')}</span>
          <input
            type="text"
            value={form.address}
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-600">{t('storeTaxId')}</span>
          <input
            type="text"
            value={form.taxId}
